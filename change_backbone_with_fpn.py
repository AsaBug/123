...
def create_model(num_classes):
    ...
    backbone = torchvision.models.mobilenet_v3_large(weights_path="./backbone/mobilenet_v3.pth")
    # print(backbone)
    ...
    # backbone = torchvision.models.efficientnet_b0(weights_path="./backbone/efficientnet_b0.pth")
    # # print(backbone)
    ...
    # return_layers = {"featrues.1" : "0",
    #                 "features.4" : "1",
    #                 "features.11" : "2"}
    # in_channels_list = [64,192,256]
    # new_backbone = create_feature_extractor(backbone, return_layers)
...
def main(args):
    ...
    # load train data set
    # VOCdevkit -> VOC2020 -> ImageSets -> Main -> train.txt
    train_dataset = VOCDataSet(VOC_root, "2024", data_transform["train"], "train.txt")
    train_sampler = None
    ...
    # VOCdevkit -> VOC2020 -> ImageSets -> Main -> val.txt
    val_dataset = VOCDataSet(VOC_root, "2024", data_transform["val"], "val.txt")
